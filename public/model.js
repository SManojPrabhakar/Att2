...
Pstresults,PlecturerlistbyCourse,PstudentslistbyCourse,deactivatestudent,rightt,verificationt,contactus,getYearlyFeeAmount};
...
async function getYearlyFeeAmount(Regno, feeyear,feetype) {
  console.log(Regno, feeyear,feetype)
  try {
